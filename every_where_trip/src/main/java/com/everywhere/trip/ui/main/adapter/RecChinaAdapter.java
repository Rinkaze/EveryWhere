...
public class RecChinaAdapter extends RecyclerView.Adapter {
    ...
    private CityBean.ResultEntity.ChinaEntity chinaEntity;
    ...
    public RecChinaAdapter(Context context, CityBean.ResultEntity.ChinaEntity chinaEntity,SideBar mSideBar) {
