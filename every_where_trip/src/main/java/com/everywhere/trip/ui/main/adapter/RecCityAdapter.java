...
public class RecCityAdapter extends RecyclerView.Adapter<RecCityAdapter.ViewHolder> {
    ...
    private List<CityBean.ResultEntity.CountriesEntity.CitiesEntity> list;

    public RecCityAdapter(Context context, List<CityBean.ResultEntity.CountriesEntity.CitiesEntity> list) {
