...
public class RecHotCityAdapter extends RecyclerView.Adapter<RecHotCityAdapter.ViewHolder> {
    ...
    private List<CityBean.ResultEntity.ChinaEntity.TopCitiesEntity> list;

    public RecHotCityAdapter(Context context, List<CityBean.ResultEntity.ChinaEntity.TopCitiesEntity> list) {
