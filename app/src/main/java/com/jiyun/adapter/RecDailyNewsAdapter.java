...
public class RecDailyNewsAdapter extends RecyclerView.Adapter {
    ...
    public RecDailyNewsAdapter(Context context, ArrayList<StoriesEntity> stories, ArrayList<DailyNewsBean.Top_storiesEntity> topStories) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == BANNER_TYPE){
            ...
            final StoriesEntity entity = stories.get(index);
            Glide.with(context)
