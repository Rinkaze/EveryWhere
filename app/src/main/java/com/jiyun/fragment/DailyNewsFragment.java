...
public class DailyNewsFragment extends BaseFragment<DailyNewsView, DailyNewsPresenter> implements DailyNewsView{
    ...
    public static StoriesEntity storiesEntity;
    ...
    protected void initView() {
        ...
        ArrayList<StoriesEntity> stories = new ArrayList<>();
    ...
    public void updateData(DailyNewsBean dailyNewsBean) {
        dailyNewsAdapter.setStories((ArrayList<StoriesEntity>) dailyNewsBean.getStories());
    ...
    protected void initListener() {
        dailyNewsAdapter.setOnItemClickListener(new RecDailyNewsAdapter.OnItemClickListener() {
            @Override
            public void onClick(String url,StoriesEntity storiesEntity) {
                DailyNewsFragment.storiesEntity = storiesEntity;
